        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          {pillars.map((pillar, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -5 }}
              className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 border border-transparent hover:border-nh-copper"
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-heading font-bold text-nh-charcoal mb-3">
                    {pillar.title}
                  </h3>
